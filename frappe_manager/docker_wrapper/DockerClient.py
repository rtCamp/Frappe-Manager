...
class DockerClient:
    ...
    def cp(
        ...
        remove_parameters = ["stream", "stream_only_exit_code", "source", "destination","source_container","destination_container"]
        ...
        iterator = run_command_with_exit_code(
            self.docker_cmd + cp_cmd, quiet=stream_only_exit_code,
            stream=stream
        )
        return iterator
    ...
    def kill(
        ...
        iterator = run_command_with_exit_code(
            self.docker_cmd + kill_cmd, quiet=stream_only_exit_code,
            stream=stream
        )
        return iterator
    ...
    def rm(
        ...
        iterator = run_command_with_exit_code(
            self.docker_cmd + rm_cmd, quiet=stream_only_exit_code,
            stream=stream
        )
        return iterator
    ...
    def run(
        ...
        iterator = run_command_with_exit_code(
            self.docker_cmd + run_cmd, quiet=stream_only_exit_code,
            stream=stream
        )
        return iterator
