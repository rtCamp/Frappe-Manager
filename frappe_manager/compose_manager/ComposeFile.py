...
class ComposeFile:
    def __init__(self,loadfile: Path, template_name = 'docker-compose.tmpl'):
    ...
    def set_secret_file_path(self,secret_name,file_path):
        try:
           ...
           richprint.exit("Not able to set secrets in compose.")
    ...
    def remove_secrets_compose(self):
        try:
            del self.yml['secrets']
        except KeyError:
           richprint.warning(f"Not able to remove secrets from site compose.")
