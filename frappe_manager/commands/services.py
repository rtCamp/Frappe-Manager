...
services_command = typer.Typer(no_args_is_help=True, rich_markup_mode="rich")
app.add_typer(services_command, name="services", help="Handle global services.")

@services_command.command(no_args_is_help=True)
def stop(
    ctx: typer.Context,
