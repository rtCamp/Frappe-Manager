...
from frappe_manager.docker import ComposeFile, DockerVolumeMount, DockerVolumeType
...
class ProxyStoragePaths:
    ...
    def _get_docker_volume_dirs(self):
        ...
        all_volumes: list[DockerVolumeMount] = self.compose_file_manager.get_service_volumes(self.service_name)
        dirs = {}
