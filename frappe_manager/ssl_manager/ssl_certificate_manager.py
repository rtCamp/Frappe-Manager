...
class SSLCertificateManager:
    ...
    def generate_certificate(self, alias_domains: list[str] | None = None):
        """
    ...
    def renew_certificate(self, alias_domains: list[str] | None = None):
        """
        ...
        if not self.needs_renewal():
            raise SSLCertificateNotDueForRenewalError(self.certificate.domain, self.get_certificate_expiry())
    ...
    def remove_certificate(self, alias_domains: list[str] | None = None):
        """
