...
class TestSiteDeletionCertificateCleanup:
    ...
    def test_remove_certificate_removes_symlinks_first(self):
        ...
        """
        # Setup
        certificate = SSLCertificate(domain="alok.rt.gw", ssl_type=SUPPORTED_SSL_TYPES.le, hsts="off")
    ...
    def test_remove_certificate_with_alias_domains(self):
        ...
        mock_link_manager.unlink_certificate.assert_called_once_with("alok.rt.gw", alias_domains)
    ...
    def test_site_deletion_flow_removes_both_primary_and_alias_certificates(self):
        ...
        assert second_call == call("alok.rt.gw", None), "Second call should remove symlinks for primary domain only"
        ...
        assert mock_nginx_controller.restart.call_count == 2, "nginx should be restarted after each certificate removal"
