...
class TestSSLCertificateManagerInitialization:
    ...
    def test_init_raises_if_certificate_is_none(
        self,
        mock_ssl_service,
        mock_link_manager,
        mock_nginx_controller
    ...
    def test_init_raises_if_service_is_none(
        self,
        mock_certificate,
        mock_link_manager,
        mock_nginx_controller
...
class TestSSLCertificateManagerSetCertificate:
    ...
    def test_set_certificate_updates_certificate(self, ssl_certificate_manager):
        ...
        new_certificate = SSLCertificate(
...
class TestSSLCertificateManagerGenerateCertificate:
    ...
    def test_generate_certificate_calls_service_and_creates_symlinks(self, ssl_certificate_manager):
        ...
        ssl_certificate_manager.service.generate_certificate.assert_called_once_with(
            ssl_certificate_manager.certificate,
            None
        )
...
class TestSSLCertificateManagerRenewCertificate:
    ...
    def test_renew_certificate_calls_service_and_updates_symlinks(self, mocker, ssl_certificate_manager):
        ...
        ssl_certificate_manager.service.renew_certificate.assert_called_once_with(
            ssl_certificate_manager.certificate
        )
...
class TestSSLCertificateManagerRemoveCertificate:
    ...
    def test_remove_certificate_unlinks_and_removes(self, ssl_certificate_manager):
        ...
        ssl_certificate_manager.service.remove_certificate.assert_called_once_with(
            ssl_certificate_manager.certificate
        )
    ...
    def test_remove_certificate_operation_order(self, ssl_certificate_manager):
        ...
        # Track call order
        ssl_certificate_manager.link_manager.unlink_certificate.side_effect = lambda *args, **kwargs: call_order.append('unlink')
        ssl_certificate_manager.service.remove_certificate.side_effect = lambda *args, **kwargs: call_order.append('remove')
        ssl_certificate_manager.nginx_controller.restart.side_effect = lambda *args, **kwargs: call_order.append('restart')
