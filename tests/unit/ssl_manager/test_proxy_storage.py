...
class TestProxyStoragePathsInitialization:
    ...
    def test_init_stores_service_name_and_compose_project(self, mocker, mock_compose_project):
        """Test that initialization stores service name and compose project."""
        # Mock the volume retrieval
        mock_compose_project.compose_file_manager.get_service_volumes.return_value = []
        
        storage = ProxyStoragePaths('nginx-proxy', mock_compose_project)
        
        assert storage.service_name == 'nginx-proxy'
        assert storage.compose_project == mock_compose_project
    
    def test_init_calls_get_docker_volume_dirs(self, mocker, mock_compose_project):
        ...
        mock_compose_project.compose_file_manager.get_service_volumes.assert_called_once_with('nginx-proxy')
    
    def test_init_sets_dirs_attribute(self, mocker, mock_compose_project):
...
class TestProxyStoragePathsGetDockerVolumeDirs:
    ...
    def test_get_docker_volume_dirs_with_bind_volumes(self, mocker, mock_compose_project):
        ...
        mock_compose_project.compose_file_manager.get_service_volumes.return_value = [mock_volume]
    ...
    def test_get_docker_volume_dirs_filters_non_bind_volumes(self, mocker, mock_compose_project):
    ...
    def test_get_docker_volume_dirs_with_multiple_bind_volumes(self, mocker, mock_compose_project):
    ...
    def test_get_docker_volume_dirs_with_no_volumes(self, mocker, mock_compose_project):
    ...
    def test_get_docker_volume_dirs_uses_host_path_name(self, mocker, mock_compose_project):
...
class TestProxyStoragePathsVolumeAccess:
    ...
    def test_volume_mount_host_path_accessible(self, mocker, mock_compose_project):
    ...
    def test_volume_mount_container_path_accessible(self, mocker, mock_compose_project):
    ...
    def test_volume_mount_type_accessible(self, mocker, mock_compose_project):
...
class TestProxyStoragePathsIntegration:
    ...
    def test_typical_nginx_proxy_configuration(self, mocker, mock_compose_project):
        ...
        mock_compose_project.compose_file_manager.get_service_volumes.return_value = volumes
