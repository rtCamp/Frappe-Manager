...
class TestLetsEncryptCertificateServiceRenewCertificate:
    ...
    def test_renew_certificate_calls_certbot_with_correct_command(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
        ...
        mock_make_dirs = mocker.patch(
            'frappe_manager.ssl_manager.letsencrypt_certificate_service.make_or_verify_needed_dirs'
        )
        mock_plugins = mocker.patch(
            'frappe_manager.ssl_manager.letsencrypt_certificate_service.plugins_disco.PluginsRegistry.find_all'
        )
    ...
    def test_renew_certificate_uses_staging_when_env_var_set(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
        ...
        service = LetsEncryptCertificateService(ssl_service_dir, webroot_dir, output_handler=mock_output)
...
class TestLetsEncryptCertificateServiceGetCertificatePaths:
    ...
    def test_get_certificate_paths_raises_if_certificate_not_found(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
...
class TestLetsEncryptCertificateServiceRemoveCertificate:
    ...
    def test_remove_certificate_calls_certbot_delete(self, mocker, tmp_path, mock_letsencrypt_certificate_http01):
        ...
        mock_output.change_head.assert_called_with('Removing Letsencrypt certificate')
        mock_output.print.assert_called_with('Removed Letsencrypt certificate')
...
class TestLetsEncryptCertificateServiceGenerateCertificateHTTP01:
    ...
    def test_generate_certificate_http01_builds_correct_command(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
    ...
    def test_generate_certificate_http01_with_alias_domains(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
...
class TestLetsEncryptCertificateServiceGenerateCertificateDNS01:
    ...
    def test_generate_certificate_dns01_creates_credentials_file(
        self, mocker, tmp_path, mock_letsencrypt_certificate_dns01
    ):
    ...
    def test_generate_certificate_dns01_removes_credentials_on_failure(
        self, mocker, tmp_path, mock_letsencrypt_certificate_dns01
    ):
...
class TestLetsEncryptCertificateServiceGenerateCertificateErrors:
    ...
    def test_generate_certificate_raises_challenge_failed_on_authorization_error(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
    ...
    def test_generate_certificate_raises_generate_failed_on_generic_error(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
...
class TestLetsEncryptCertificateServiceStagingMode:
    ...
    def test_generate_certificate_uses_staging_when_env_var_is_1(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
    ...
    def test_generate_certificate_uses_production_when_env_var_not_set(
        self, mocker, tmp_path, mock_letsencrypt_certificate_http01
    ):
